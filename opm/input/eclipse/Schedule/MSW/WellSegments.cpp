...
namespace Opm {
    ...
    WellSegments::WellSegments(double length_top,
                               const std::vector<std::pair<double, double>>& intersections,
                               double diameter)
    {
        this->addWellSegmentsFromIntersections(length_top, intersections, diameter);
    }
    ...
    void WellSegments::addWellSegmentsFromIntersections(double length_top,
                                                        const std::vector<std::pair<double, double>>& intersections,
                                                        double diameter)
    {
        ...
        m_comp_pressure_drop = WellSegments::CompPressureDrop::HF_;
        ...
        const double volume_top = 1.0e-5;
        ...
        this->process(WellSegments::LengthDepth::ABS, length_top, length_top);
    }
